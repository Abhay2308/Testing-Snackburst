        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {PRODUCTS.map((product) => (
            ...
            >
              ...
              <div className="px-2">
                <h3 className="font-poppins font-black text-3xl md:text-4xl group-hover:text-brandOrange transition-all duration-500 uppercase tracking-tighter leading-[0.9]">
                  {product.name}
                </h3>
